...
axres mips32_byte_to_raw(
	...
	_eval_type_r(instr, buf);
	if (buf->opcode == MIPS32_OPCODE_INVALID){
		return AX_MTE_INV_OPCODE;
	}
...
u8 mips32_eval_r(
	...
	switch(i){
	case 0:
		return mips32_eval_funct(lb_char, rb_char);
	case 1:
	case 2:
	case 3:
	case 4:
...
u8 mips32_eval_funct(
	...
	io_i64(mips32_opcode_lookup(lb_char, rb_char - lb_char));
	return 0;
}
