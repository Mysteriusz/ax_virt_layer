...
typedef enum _ir_opcode : u16{
	...
	IR_OR_I64	= IR_OPI(1, IR_64BIT, IR_GROUP_OR),	 // op[0] = or i64 op[1], op[2]
	IR_OR_I32	= IR_OPI(1, IR_32BIT, IR_GROUP_OR),	 // op[0] = or i32 op[1], op[2]
	IR_OR_I16	= IR_OPI(1, IR_16BIT, IR_GROUP_OR),	 // op[0] = or i16 op[1], op[2]
	IR_OR_I8	= IR_OPI(1, IR_8BIT, IR_GROUP_OR),	 // op[0] = or i8 op[1], op[2]

	IR_AND_I64	= IR_OPI(1, IR_64BIT, IR_GROUP_AND),	 // op[0] = and i64 op[1], op[2]
	IR_AND_I32	= IR_OPI(1, IR_32BIT, IR_GROUP_AND),	 // op[0] = and i32 op[1], op[2]
	IR_AND_I16	= IR_OPI(1, IR_16BIT, IR_GROUP_AND),	 // op[0] = and i16 op[1], op[2]
	IR_AND_I8	= IR_OPI(1, IR_8BIT, IR_GROUP_AND),	 // op[0] = and i8 op[1], op[2]

	IR_SUB_I64	= IR_OPI(1, IR_64BIT, IR_GROUP_SUB),	 // op[0] = sub i64 op[1], op[2]
	IR_SUB_I32	= IR_OPI(1, IR_32BIT, IR_GROUP_SUB),	 // op[0] = sub i32 op[1], op[2]
	IR_SUB_I16	= IR_OPI(1, IR_16BIT, IR_GROUP_SUB),	 // op[0] = sub i16 op[1], op[2]
	IR_SUB_I8	= IR_OPI(1, IR_8BIT, IR_GROUP_SUB),	 // op[0] = sub i8 op[1], op[2]

	IR_MOV_I64	= IR_OPI(1, IR_64BIT, IR_GROUP_MOV),	 // op[0] = mov i64 op[1]
	IR_MOV_I32	= IR_OPI(1, IR_32BIT, IR_GROUP_MOV),	 // op[0] = mov i32 op[1]
	IR_MOV_I16	= IR_OPI(1, IR_16BIT, IR_GROUP_MOV),	 // op[0] = mov i16 op[1]
	IR_MOV_I8	= IR_OPI(1, IR_8BIT, IR_GROUP_MOV),	 // op[0] = mov i8 op[1]
} ir_opcode;
